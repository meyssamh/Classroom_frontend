export interface ButtonProps {
	text: string;
	variant: 'text' | 'text-slim' | 'text-disabled' | 'outlined' | 'contained-danger' |
	'contained-danger-slim' | 'contained' | 'contained-disabled' | 'contained-slim' |
	'contained-long' | 'contained-long-disabled';
	onClick?: React.MouseEventHandler<HTMLButtonElement>;
}

export interface IconButtonProps {
	icon: 'submit' | 'submit-danger' | 'cancel';
...
export interface StudentTagProps {
	text: string;
	variant: 'unresolved' | 'absent' | 'present';
	onClick?: React.MouseEventHandler<HTMLButtonElement>;
	onAbsentClick?: React.MouseEventHandler<HTMLButtonElement>;
	onPresentClick?: React.MouseEventHandler<HTMLButtonElement>;
}
