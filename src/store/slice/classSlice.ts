...
const classSlice = createSlice({
	...
	extraReducers: (builder) => {
		...
		builder.addCase(fetchEditStudent.pending, state => {
			state.loading = 'pending';
			state.error = null;
		});
		builder.addCase(fetchEditStudent.fulfilled, (state, action) => {
		...
		builder.addCase(fetchEditStudent.rejected, (state, action) => {
			const errorPayload: any = action.payload;
			state.loading = 'failed';
			state.error = errorPayload.message;
		});
		...
		builder.addCase(fetchEditSession.pending, state => {
			state.loading = 'pending';
			state.error = null;
		});
		builder.addCase(fetchEditSession.fulfilled, (state, action) => {
		...
		builder.addCase(fetchEditSession.rejected, (state, action) => {
			const errorPayload: any = action.payload;
			state.loading = 'failed';
			state.error = errorPayload.message;
		});
